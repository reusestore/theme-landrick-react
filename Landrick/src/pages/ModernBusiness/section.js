        ...
        >
          ...
          <Container>
            <Row className="align-items-center mt-md-5">
              ...
              >
                <Card className="login_page shadow rounded border-0 mr-lg-3">
                  <CardBody>
              ...
              <Col
                ...
                xs={{ order: 1 }}
              >
                <div className="title-heading mt-4 ml-lg-4">
                  ...
                  <div className="watch-video mt-4 pt-2">
                    ...
                    <Link
                      ...
                      className="video-play-icon watch title-dark text-light mb-2 ml-1"
                    >
