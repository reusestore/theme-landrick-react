          ...
          <Row className="justify-content-center" id="counter">
            <Col lg={8} md={10}>
              <div className="mb-4 pb-2 text-center">
                <h5 className="mb-0 font-weight-normal text-muted">
                  Join{" "}
              ...
              <ul className="text-center mb-0 p-0">
                <li className="list-inline-item mx-2 mt-3">
                  <Link
                    id="facebook"
                    to="#"
                    className="btn btn-icon btn-pills btn-lg btn-blue mr-1"
                  >
                    <i>
                ...
                <li className="list-inline-item mx-2 mt-3">
                  <Link
                    to="#"
                    id="instagram"
                    className="btn btn-icon btn-pills btn-lg btn-danger mr-1"
                  >
                    <i>
                ...
                <li className="list-inline-item mx-2 mt-3">
                  <Link
                    to="#"
                    id="linkedin"
                    className="btn btn-icon btn-pills btn-lg btn-secondary mr-1"
                  >
                    <i>
                ...
                <li className="list-inline-item mx-2 mt-3">
                  <Link
                    to="#"
                    id="twitter"
                    className="btn btn-icon btn-pills btn-lg btn-info mr-1"
                  >
                    <i>
                ...
                <li className="list-inline-item mx-2 mt-3">
                  <Link
                    to="#"
                    id="gitlab"
                    className="btn btn-icon btn-pills btn-lg btn-warning mr-1"
                  >
                    <i>
                ...
                <li className="list-inline-item mx-2 mt-3">
                  <Link
                    ...
                    className="btn btn-icon btn-pills btn-lg btn-info mr-1"
                  >
                    <i className="mdi mdi-snapchat icons"></i>
                  </Link>
                </li>
                ...
                <li className="list-inline-item mx-2 mt-3">
                  <Link
                    ...
                    className="btn btn-icon btn-pills btn-lg btn-danger mr-1"
                  >
                    <i className="mdi mdi-pinterest icons"></i>
                  </Link>
                </li>
                ...
                <li className="list-inline-item mx-2 mt-3">
                  <Link
                    to="#"
                    id="whatsapp"
                    className="btn btn-icon btn-pills btn-lg btn-success mr-1"
                  >
