        ...
        <section className="section">
          <Container>
            <Row>
              ...
              <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                <Card
                  className="course-feature text-center overflow-hidden rounded shadow border-0"
                  style={{ margin: 0 }}
                >
            ...
            <Row>
              ...
              <Col lg={4} md={6} xs={12} className=" mt-4 pt-2">
                <Card className=" customer-testi m-2 text-center rounded shadow border-0">
                  <CardBody>
                    <p className="text-muted h6 font-italic">
                  ...
                  <Row className="align-items-center no-gutters">
                    ...
                    <Col md={7}>
                      <CardBody className="customer-testi">
                        ...
                        <p className="text-muted h6 mb-0 font-italic">
                    ...
                    <div className="content">
                      ...
                      <ul className="post-meta mb-0 mt-2 text-white list-unstyled">
                        <li className="list-inline-item mr-3">
                          <i className="mdi mdi-bed-empty mdi-24px mr-2"></i>1
                          Bed
                        </li>
                        <li className="list-inline-item">
                          <i className="mdi mdi-scale-bathroom mdi-24px mr-2"></i>
                          1 Bathrooms
                        </li>
                      </ul>
