                ...
                <div className="sticky-bar component-wrapper bg-light rounded shadow p-4">
                  ...
                  >
                    <ul className="list-unstyled mb-0">
                      ...
                      <li>
                        <Link to="#display" className="mouse-down h6 text-dark">
                          Display Heading
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="#buttons" className="mouse-down h6 text-dark">
                          Buttons
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="#badges" className="mouse-down h6 text-dark">
                          Badges
                        </Link>
                      </li>
                      <li>
                        <Link to="#alerts" className="mouse-down h6 text-dark">
                          Alerts
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="#cards" className="mouse-down h6 text-dark">
                          Cards
                        </Link>
                      </li>
                      <li>
                        <Link to="#forms" className="mouse-down h6 text-dark">
                          Forms
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="#switches" className="mouse-down h6 text-dark">
                          Switches Buttons
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="#map" className="mouse-down h6 text-dark">
                          Google Map
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="#avatar" className="mouse-down h6 text-dark">
                          Avatar
                        </Link>
                      </li>
                      <li>
                        <Link to="#nav-tabs" className="mouse-down h6 text-dark">
                          Nav Tabs
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="#tooltips" className="mouse-down h6 text-dark">
                          Tooltips
                        </Link>
                      </li>
                      <li>
                        <Link to="#modals" className="mouse-down h6 text-dark">
                          Modals
                        </Link>
                      </li>
                      <li>
                        <Link to="#tables" className="mouse-down h6 text-dark">
                          Tables
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link to="#icons" className="mouse-down h6 text-dark">
                          Icons
                        </Link>
                      </li>
                    </ul>
                  ...
                  <Col className="mt-4 pt-2" id="buttons">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link to="#" className="btn btn-secondary mt-2 mr-2">
                          Secondary
                        </Link>
                        <Link to="#" className="btn btn-success mt-2 mr-2">
                          Success
                        </Link>
                        <Link to="#" className="btn btn-danger mt-2 mr-2">
                          Danger
                        </Link>
                        <Link to="#" className="btn btn-info mt-2 mr-2">
                          Info
                        </Link>
                        <Link to="#" className="btn btn-warning mt-2 mr-2">
                          Warning
                        </Link>
                        <Link to="#" className="btn btn-light mt-2 mr-2">
                          Light
                        </Link>
                        <Link to="#" className="btn btn-dark mt-2 mr-2">
                          Dark
                        </Link>
                      </div>
                    </div>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link
                          to="#"
                          className="btn btn-pills btn-primary mt-2 mr-2"
                        >
                          Primary
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-secondary mt-2 mr-2"
                        >
                          Secondary
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-success mt-2 mr-2"
                        >
                          Success
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-danger mt-2 mr-2"
                        >
                          Danger
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-info mt-2 mr-2"
                        >
                          Info
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-warning mt-2 mr-2"
                        >
                          Warning
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-light mt-2 mr-2"
                        >
                          Light
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-dark mt-2 mr-2"
                        >
                          Dark
                        </Link>
                      </div>
                  ...
                  <Col className="mt-4 pt-2" id="buttons">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link to="#" className="btn btn-soft-primary mt-2 mr-2">
                          Primary
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-soft-secondary mt-2 mr-2"
                        >
                          Secondary
                        </Link>
                        <Link to="#" className="btn btn-soft-success mt-2 mr-2">
                          Success
                        </Link>
                        <Link to="#" className="btn btn-soft-danger mt-2 mr-2">
                          Danger
                        </Link>
                        <Link to="#" className="btn btn-soft-info mt-2 mr-2">
                          Info
                        </Link>
                        <Link to="#" className="btn btn-soft-warning mt-2 mr-2">
                          Warning
                        </Link>
                        <Link to="#" className="btn btn-soft-light mt-2 mr-2">
                          Light
                        </Link>
                        <Link to="#" className="btn btn-soft-dark mt-2 mr-2">
                          Dark
                        </Link>
                      </div>
                    </div>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link
                          to="#"
                          className="btn btn-pills btn-soft-primary mt-2 mr-2"
                        >
                          Primary
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-soft-secondary mt-2 mr-2"
                        >
                          Secondary
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-soft-success mt-2 mr-2"
                        >
                          Success
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-soft-danger mt-2 mr-2"
                        >
                          Danger
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-soft-info mt-2 mr-2"
                        >
                          Info
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-soft-warning mt-2 mr-2"
                        >
                          Warning
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-soft-light mt-2 mr-2"
                        >
                          Light
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-soft-dark mt-2 mr-2"
                        >
                          Dark
                        </Link>
                      </div>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link
                          to="#"
                          className="btn btn-outline-danger mt-2 mr-2"
                        >
                          Danger
                        </Link>
                        <Link to="#" className="btn btn-outline-info mt-2 mr-2">
                          Info
                        </Link>
                        <Link
                          to="#"
                        ...
                        <Link
                          to="#"
                          className="btn btn-outline-light mt-2 mr-2"
                        >
                          Light
                        </Link>
                        <Link to="#" className="btn btn-outline-dark mt-2 mr-2">
                          Dark
                        </Link>
                      </div>
                    </div>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link
                          to="#"
                          className="btn btn-pills btn-outline-primary mt-2 mr-2"
                        >
                          Primary
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-outline-secondary mt-2 mr-2"
                        >
                          Secondary
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-outline-success mt-2 mr-2"
                        >
                          Success
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-outline-danger mt-2 mr-2"
                        >
                          Danger
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-outline-info mt-2 mr-2"
                        >
                          Info
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-outline-warning mt-2 mr-2"
                        >
                          Warning
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-outline-light mt-2 mr-2"
                        >
                          Light
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-pills btn-outline-dark mt-2 mr-2"
                        >
                          Dark
                        </Link>
                      </div>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-primary mt-2 mr-1"
                        >
                          <i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-info mt-2 mr-1"
                        >
                          <i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-danger mt-2 mr-1"
                        >
                          <i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-success mt-2 mr-1"
                        >
                          <i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-secondary mt-2 mr-1"
                        >
                          <i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-warning mt-2 mr-1"
                        >
                          <i>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-outline-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-outline-info mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="twitter" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-outline-danger mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="youtube" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-outline-success mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="gitlab" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-outline-secondary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="linkedin" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-outline-warning mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="github" className="icons" />
                          </i>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-info mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="twitter" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-danger mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="youtube" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-success mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="gitlab" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-secondary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="linkedin" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-warning mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="github" className="icons" />
                          </i>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-outline-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-outline-info mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="twitter" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-outline-danger mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="youtube" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-outline-success mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="gitlab" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-outline-secondary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="linkedin" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-pills btn-outline-warning mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="github" className="icons" />
                          </i>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link
                          to="#"
                          className="btn btn-sm btn-pills btn-primary mt-2 mr-2"
                        >
                          Small
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-sm btn-outline-primary mt-2 mr-2"
                        >
                          Small
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-sm btn-pills btn-outline-primary mt-2 mr-2"
                        >
                          Small
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-icon btn-sm btn-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-sm btn-pills btn-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-sm btn-outline-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-sm btn-pills btn-outline-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-lg btn-primary mt-2 mr-2"
                        >
                          Large
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-lg btn-pills btn-primary mt-2 mr-2"
                        >
                          Large
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-lg btn-outline-primary mt-2 mr-2"
                        >
                          Large
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-lg btn-pills btn-outline-primary mt-2 mr-2"
                        >
                          Large
                        </Link>
                        <Link
                          to="#"
                          className="btn btn-icon btn-lg btn-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-lg btn-pills btn-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-lg btn-outline-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                        ...
                        <Link
                          to="#"
                          className="btn btn-icon btn-lg btn-pills btn-outline-primary mt-2 mr-1"
                        >
                          <i>
                            <FeatherIcon icon="facebook" className="icons" />
                          </i>
                  ...
                  <Col className="mt-4 pt-2" id="badges">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Badge color="primary" className="mr-2 mt-2">
                          Primary
                        </Badge>
                        <Badge color="secondary" className="mr-2 mt-2">
                          Secondary
                        </Badge>
                        <Badge color="success" className="mr-2 mt-2">
                          Success
                        </Badge>
                        <Badge color="danger" className="mr-2 mt-2">
                          Danger
                        </Badge>
                        <Badge color="warning" className="mr-2 mt-2">
                          Warning
                        </Badge>
                        <Badge color="info" className="mr-2 mt-2">
                          Info
                        </Badge>
                        <Badge color="Light" className="mr-2 mt-2">
                          light
                        </Badge>
                        <Badge color="dark" className="mr-2 mt-2">
                          Dark
                        </Badge>
                      </div>
                    </div>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Badge color="primary" pill className="mr-2 mt-2">
                          Primary
                        </Badge>
                        <Badge color="secondary" pill className="mr-2 mt-2">
                          Secondary
                        </Badge>
                        <Badge color="success" pill className="mr-2 mt-2">
                          Success
                        </Badge>
                        <Badge color="danger" pill className="mr-2 mt-2">
                          Danger
                        </Badge>
                        <Badge color="warning" pill className="mr-2 mt-2">
                          Warning
                        </Badge>
                        <Badge color="info" pill className="mr-2 mt-2">
                          Info
                        </Badge>
                        <Badge color="Light" pill className="mr-2 mt-2">
                          light
                        </Badge>
                        <Badge color="dark" pill className="mr-2 mt-2">
                          Dark
                        </Badge>
                      </div>
                    </div>
                    ...
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Badge
                          color="none"
                          pill
                          className="badge-outline-primary mr-2 mt-2"
                        >
                          Primary
                        </Badge>
                        <Badge
                          color="none"
                          pill
                          className="badge-outline-secondary mr-2 mt-2"
                        >
                          Secondary
                        </Badge>
                        <Badge
                          color="none"
                          pill
                          className="badge-outline-danger mr-2 mt-2"
                        >
                          Danger
                        </Badge>
                        <Badge
                          color="none"
                          pill
                          className="badge-outline-warning mr-2 mt-2"
                        >
                          Warning
                        </Badge>
                        <Badge
                          color="none"
                          pill
                          className="badge-outline-info mr-2 mt-2"
                        >
                          Info
                        </Badge>
                        <Badge
                          color="none"
                          pill
                          className="badge-outline-light mr-2 mt-2"
                        >
                          Light
                        </Badge>
                        <Badge
                          color="none"
                          pill
                          className="badge-outline-dark mr-2 mt-2"
                        >
                          Dark
                        </Badge>
                      </div>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <Link to="#" className="badge badge-primary mr-2 mt-2">
                          Primary
                        </Link>
                        <Link
                          to="#"
                          className="badge badge-secondary mr-2 mt-2"
                        >
                          Secondary
                        </Link>
                        <Link to="#" className="badge badge-success mr-2 mt-2">
                          Success
                        </Link>
                        <Link to="#" className="badge badge-danger mr-2 mt-2">
                          Danger
                        </Link>
                        <Link to="#" className="badge badge-warning mr-2 mt-2">
                          Warning
                        </Link>
                        <Link to="#" className="badge badge-info mr-2 mt-2">
                          Info
                        </Link>
                        <Link to="#" className="badge badge-light mr-2 mt-2">
                          Light
                        </Link>
                        <Link to="#" className="badge badge-dark mr-2 mt-2">
                          Dark
                        </Link>
                      </div>
                    </div>
                  ...
                  <Col className="mt-4 pt-2" id="avatar">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <img
                          src={client05}
                          className="img-fluid avatar avatar-ex-sm mr-2 rounded"
                          alt="Landrick"
                        />
                        <img
                          src={client05}
                          className="img-fluid avatar avatar-md-sm mr-2 rounded"
                          alt="Landrick"
                        />
                        <img
                          src={client05}
                          className="img-fluid avatar avatar-small mr-2 rounded"
                          alt="Landrick"
                        />
                        <img
                          src={client05}
                          className="img-fluid avatar avatar-medium mr-2 rounded"
                          alt="Landrick"
                        />
                        <img
                          src={client05}
                          className="img-fluid avatar avatar-large mt-3 mt-sm-0 mr-2 rounded"
                          alt="Landrick"
                        />
                      </div>
                    </div>
                  ...
                  <Col className="mt-4 pt-2">
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        ...
                        <img
                          src={client05}
                          className="img-fluid avatar avatar-ex-sm mr-2 rounded-circle"
                          alt="Landrick"
                        />
                        <img
                          src={client05}
                          className="img-fluid avatar avatar-md-sm mr-2 rounded-circle"
                          alt="Landrick"
                        />
                        <img
                          src={client05}
                          className="img-fluid avatar avatar-small mr-2 rounded-circle"
                          alt="Landrick"
                        />
                        <img
                          src={client05}
                          className="img-fluid avatar avatar-medium mr-2 rounded-circle"
                          alt="Landrick"
                        />
                        <img
                          src={client05}
                          className="img-fluid avatar avatar-large mt-3 mt-sm-0 mr-2 rounded-circle"
                          alt="Landrick"
                        />
                      </div>
                    </div>
