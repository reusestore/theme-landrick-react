              ...
              <Col>
                ...
                <div className="mt-4 p-4 bg-light rounded shadow">
                  <p className="mb-0 text-muted">
                    ...
                    <code className="font-weight-bold">style.scss</code>
                  </p>
                </div>
                ...
                <div className="mt-4 p-4 bg-light rounded shadow">
                  <p className="mb-0 text-muted">
                    ...
                    css of <code className="font-weight-bold">default.css</code>{" "}
                    to <code className="font-weight-bold">green.scss</code>(or
