              ...
              <Col lg={9}>
                <div className="p-4 shadow rounded border">
                  ...
                  <ul className="list-unstyled">
                    <li className="text-muted my-2 ml-3">
                      <i>
                        <FeatherIcon
                      ...
                      <span className="font-weight-bold">Fixed :</span> Fixed
                  ...
                  {/* v2.6.0 */}
                  {/* <h5 className="mt-5">
                    Version <span className="text-success">2.6.0</span> - 7th
                    November 2020
                  </h5> */}
                  <ul className="list-unstyled">
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Developer
                      Landing{" "}
                      <Link
                        to="index-developer"
                        target="_blank"
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> SEO Agency
                      Landing{" "}
                      <Link
                        to="index-seo-agency"
                        target="_blank"
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Real
                      Estate Landing{" "}
                      <Link
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Hospital
                      Landing{" "}
                      <Link
                        to="index-hospital"
                        target="_blank"
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Landing
                      Four{" "}
                      <Link
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> IT
                      Solution Landing{" "}
                      <Link
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Corporate
                      Business{" "}
                      <Link
                        to="index-corporate"
                        target="_blank"
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Email
                      Inbox Landing{" "}
                      <Link
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Task
                      Management Landing{" "}
                      <Link
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Travel
                      Landing{" "}
                      <Link
                        to="index-travel"
                        target="_blank"
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Blog
                      Landing{" "}
                      <Link
                        to="index-blog"
                        target="_blank"
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Forums{" "}
                      <Link
                        to="forums"
                        target="_blank"
                        className="h6 text-danger"
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">Added :</span> Product
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">Added :</span> Company
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">Added :</span>{" "}
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">Added :</span> Thank
                  ...
                  {/* <h5>
                    Version <span className="text-success">2.5.0</span> - 31st
                    July 2020{" "}
                    <span className="badge badge-pill badge-danger ml-2">
                      Latest Updated
                    </span>
                  ...
                  <ul className="list-unstyled">
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">New :</span> Case Study
                      Pages
                      <ul className="list-unstyled">
                        <li className="text-muted my-2 ml-3">
                          <FeatherIcon
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">Added :</span> New Blog
                      Details Page
                    </li>
                    <li className="text-muted my-2 ml-3">
                      <i>
                      ...
                      <span className="font-weight-bold">Added :</span> New
                      About Us Page
                    </li>
                    <li className="text-muted my-2 ml-3">
                      <i>
                    ...
                    <li className="text-muted my-2 ml-3">
                      ...
                      <span className="font-weight-bold">Added :</span> User
                      Account Pages
                      <ul className="list-unstyled">
                        <li className="text-muted my-2 ml-3">
                          <FeatherIcon
                  ...
                  <ul className="list-unstyled">
                    <li className="text-muted my-2 ml-3">
                      ...
                      Update Latest{" "}
                      <span className="font-weight-bold">Bootstrap v4.5</span>
                    </li>
                    <li className="text-muted my-2 ml-3">
                      <i>
                        <FeatherIcon
