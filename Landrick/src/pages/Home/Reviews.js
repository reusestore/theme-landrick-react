                    ...
                    <Col xs={12}>
                        <div className="section-title text-center">
                            ...
                            <div className="mt-4 pt-2">
                                <Link to="https://1.envato.market/landrickreactjs" target="_blank" className="btn btn-primary">Download Now <span className="badge badge-pill badge-danger ml-2">v2.6</span></Link>
                            </div>
                        </div>
                    </Col>  
                </Row>
