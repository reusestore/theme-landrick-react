      ...
      <React.Fragment>
        <Container>
          <Row className="align-items-center">
            <Col md={6}>
              <div className="bg-light p-5 rounded-md shadow mr-lg-5">
                <img
                  src={about}
            ...
            <Col md={6} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
              <div className="section-title">
                ...
                <ul className="list-unstyled text-muted my-4">
                  <li className="list-inline-item mr-lg-5 mr-4">
                ...
                <Media className="align-items-center mt-4">
                  <img
                    src={client05}
        ...
        <Container className="mt-100 mt-60">
          <Row>
            <Col lg={4} md={6} xs={12}>
              <Media className="features feature-clean">
