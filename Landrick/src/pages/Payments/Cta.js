                        ...
                        <Row className="justify-content-center">
                            ...
                            <div className="section-title">
                                ...
                                <div className="contact-detail mt-5">
                                    ...
                                    <Link to="https://1.envato.market/landrickreactjs" target="_blank" rel="noopener noreferrer" className="btn btn-primary mt-3">Get Started <Badge pill color="danger" className="ml-2">v2.6</Badge></Link>
                                </div>
                            </Col>
                        </Row>
                    </Container>
