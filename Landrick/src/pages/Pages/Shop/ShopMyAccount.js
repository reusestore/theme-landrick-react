                ...
                >
                  <NavItem>
                    ...
                    >
                      <div className="text-left py-1 px-3">
                        <h6 className="mb-0">
                          <i className="uil uil-dashboard h5 align-middle mr-2 mb-0"></i>{" "}
                          Dashboard
                        </h6>
                      </div>
                    </NavLink>
                  ...
                  <NavItem className="mt-2">
                    ...
                    >
                      <div className="text-left py-1 px-3">
                        <h6 className="mb-0">
                          <i className="uil uil-arrow-circle-down h5 align-middle mr-2 mb-0"></i>{" "}
                          Downloads
                        </h6>
                      </div>
                    </NavLink>
                  ...
                  <NavItem className="mt-2">
                    <Link className="nav-link rounded" to="/auth-login">
                      <div className="text-left py-1 px-3">
                        <h6 className="mb-0">
                          <i className="uil uil-sign-out-alt h5 align-middle mr-2 mb-0"></i>{" "}
                          Logout
                        </h6>
                      </div>
                    </Link>
